...
import {
    isValidAmount, toDNC20TokenLargestUnit
} from '../../utils/Utils';
import FlatButton from "../buttons/FlatButton";
import {WDneroAsset} from "../../constants/assets";

export default function UnwrapDneroTxForm(props){
    ...
    const populateMaxAmount = () => {
        const asset = WDneroAsset(chainId);
        const balance = selectedAccount.balances[asset.address] || '0';
        let amount = toDNC20TokenLargestUnit(balance, asset.decimals).toString(10);
